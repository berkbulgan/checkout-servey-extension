...
${errorInfo.componentStack}`);
  ...
  function Completed() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "Thanks for your feedback!" });
  }
  function Survey({ lineItems, setCompleted }) {
    const [selectedItem, setSelectedItem] = (0, import_react16.useState)(
    ...
    return loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Loading, {}) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "Which product did need the most?" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        ChoiceList2,
        {
          ...
          variant: "base",
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: lineItems.map((item, index) => {
            const id = item.id.toString().split("/").at(-1);
            return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice2, { id, children: item.merchandise.title }, id);
          }) })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "secondary", onPress: handleSubmit, children: "Submit feedback" })
    ] });
  }
  function Extension() {
    const cartLines = useCartLines();
    const [completed, setCompleted] = (0, import_react16.useState)(false);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: cartLines.length > 1 ? completed ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Completed, {}) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Survey, { lineItems: cartLines, setCompleted }) : null }) });
  }
})();
